...
class AzureDevOpsIntegration:
    ...
    async def _create_pipeline_run(
        ...
        if existing_run:
            ...
            existing_run.finished_at = self._parse_azure_timestamp(
                resource.get('finishTime')
            ) if status in [PipelineStatus.SUCCESS, PipelineStatus.FAILURE] else None
            return existing_run
